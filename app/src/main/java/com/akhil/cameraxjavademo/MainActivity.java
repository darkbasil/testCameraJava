                ...
                public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ExifInterface ef = new ExifInterface(file);
                                //
                                ef.setAttribute(ExifInterface.TAG_GPS_LATITUDE, dec2DMS(65.5));
                                ef.setAttribute(ExifInterface.TAG_GPS_LONGITUDE,dec2DMS(82.2));
